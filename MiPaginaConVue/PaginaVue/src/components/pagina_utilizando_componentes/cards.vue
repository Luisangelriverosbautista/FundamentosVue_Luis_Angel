...
import album4 from '../../assets/twenty_one_pilots_blurryface-portada.jpg';
    ...
    <div class="container">
            ...
            <div class="col-md-6">
                <div class="card ">
                    <div class="card-header text-center"
                        style="background: linear-gradient(to right, #000000, #1fff0ff5);">
                        <h5 style="color: white;">Twenty One Pilots</h5>
                    </div>
                    <div class="card-body text-center">
                        <img :src="album1" alt="Twenty One Pilots album" class="img-fluid" style="border-radius: 10%;"
                        ...
                        de significado. En sus letras se siente el eco de una mente que aún no ha sido filosófica de la
                        banda: preguntas sin respuesta, pensamientos en espiral y una esperanza
                        frágil que aún no ha sido puesta a prueba.
                        </p>
                        <a href="https://open.spotify.com/playlist/3tc8aLDGfRto15WXLAcEXk?si=103a9ls8TJCVGYpOIsQqWg"
                            target="_blank" style="text-decoration: none;">
                            <button class="btn"
                                style="background-color: black; color: white; border: none; padding: 10px 15px; cursor: pointer;">
        ...
        <div class="row justify-content-end">
            <div class="col-md-6">
                <div class="card mt-3">
                    <div class="card-header text-center"
                        style="background: linear-gradient(to right, #000000, #1563a7f5);">
                        <h5 style="color: white;">Regional at Best</h5>
                    </div>
                    <div class="card-body text-center">
                        <img :src="album2" alt="Regional at Best album" class="img-fluid" style="border-radius: 10%;"
                            width="400" height="400">
                        <p>
                        ...
                        <a href="https://open.spotify.com/intl-es/album/2pvaY5uQvitGuztVNfsRR8?si=38i09lXBQv6b7tHAYFWcTA"
                            target="_blank" style="text-decoration: none;">
                            <button class="btn"
                                style="background-color: black; color: white; border: none; padding: 10px 15px; cursor: pointer;">
                                <i class="bi bi-music-note-beamed"></i> Escuchar álbum
        ...
        <div class="row justify-content-start">
            <div class="col-md-6">
                <div class="card mt-3">
                    <div class="card-header text-center"
                        style="background: linear-gradient(to right, #000000, #fffffff5);">
                        <h5 style="color: white;">Vessel</h5>
                    </div>
                    <div class="card-body text-center">
                        <img :src="album3" alt="Vessel album" class="img-fluid" style="border-radius: 10%;" width="400"
                            height="400">
                        <p>
                        ...
                        <a href="https://open.spotify.com/intl-es/album/2r2r78NE05YjyHyVbVgqFn?si=lgz0SdAWQGeV5x1GsEKVew"
                            target="_blank" style="text-decoration: none;">
                            <button class="btn"
                                style="background-color: black; color: white; border: none; padding: 10px 15px; cursor: pointer;">
                                <i class="bi bi-music-note-beamed"></i> Escuchar álbum
        ...
        <div class="row justify-content-end">
            <div class="col-md-6">
                <div class="card mt-3">
                    <div class="card-header text-center"
                        style="background: linear-gradient(to right, #000000, #d11e1e);">
                        <h5 style="color: white;">Blurryface</h5>
                    </div>
                    <div class="card-body text-center">
                        <img :src="album4" alt="Blurryface album" style="border-radius: 10%;" class="img-fluid"
                            width="400" height="400">
                        <p>
                        ...
                        <a href="https://open.spotify.com/intl-es/album/3cQO7jp5S9qLBoIVtbkSM1?si=1YTmLUvlQPenB9Le9KJtTw"
                            target="_blank" style="text-decoration: none;">
                            <button class="btn"
                                style="background-color: black; color: white; border: none; padding: 10px 15px; cursor: pointer;">
                                <i class="bi bi-music-note-beamed"></i> Escuchar álbum
        ...
        <div class="row justify-content-start">
            <div class="col-md-6">
                <div class="card mt-3">
                    <div class="card-header text-center"
                        style="background: linear-gradient(to right, #000000, #c2d11e);">
                        <h5 style="color: white;">Trench</h5>
                    </div>
                    <div class="card-body text-center">
                        <img :src="album5" alt="Trench album" style="border-radius: 10%;" class="img-fluid" width="400"
                            height="400">
                        <p>
                        ...
                        <a href="https://open.spotify.com/intl-es/album/621cXqrTSSJi1WqDMSLmbL?si=lO0093WFQJqtEAh5s0CzQw"
                            target="_blank" style="text-decoration: none;">
                            <button class="btn"
                                style="background-color: black; color: white; border: none; padding: 10px 15px; cursor: pointer;">
                                <i class="bi bi-music-note-beamed"></i> Escuchar álbum
        ...
        <div class="row justify-content-end">
            <div class="col-md-6">
                <div class="card mt-3">
                    <div class="card-header text-center"
                        style="background: linear-gradient(to right, #1563a7f5, #da1dbef5);">
                        <h5 style="color: white;">Scaled and Icy</h5>
                    </div>
                    <div class="card-body text-center">
                        <img :src="album6" alt="Scaled and Icy album" class="img-fluid" style="border-radius: 10%;"
                            width="400" height="400">
                        <p>
                        ...
                        <a href="https://open.spotify.com/intl-es/album/0Q5XBpCYFgUWiG9DUWyAmJ?si=ccS7YPR2ROyDRZKgBZWoQA"
                            target="_blank" style="text-decoration: none;">
                            <button class="btn"
                                style="background-color: black; color: white; border: none; padding: 10px 15px; cursor: pointer;">
                                <i class="bi bi-music-note-beamed"></i> Escuchar álbum
        ...
        <div class="row justify-content-start">
            <div class="col-md-6">
                <div class="card mt-3">
                    <div class="card-header text-center"
                        style="background: linear-gradient(to right, #d11e1e, #d4cb1c);">
                        <h5 style="color: white;">Clancy</h5>
                    </div>
                    <div class="card-body text-center">
                        <img :src="album7" alt="Scaled and Icy album" class="img-fluid" style="border-radius: 10%;"
                            width="400" height="400">
                        <p>
                        ...
                        <a href="https://open.spotify.com/intl-es/album/1KFWgQTw3EMTQebaaepVBI?si=zVVzM98KR7KvCsXNTMtGjQ"
                            target="_blank" style="text-decoration: none;">
                            <button class="btn"
                                style="background-color: black; color: white; border: none; padding: 10px 15px; cursor: pointer;">
                                <i class="bi bi-music-note-beamed"></i> Escuchar álbum
